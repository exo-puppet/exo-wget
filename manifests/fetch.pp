...
#
# [+timeout+]
#   The maximum time the download should take. If the command takes longer than the timeout, the download is considered to have
#   failed.
#   The time is specified in seconds. (default: 0 which mean no timeout)
#
# [+check_certificate+]
#   do we need to check the ssl certificate (usefull to deactivate when there is self signed certificate or a certificate problem)
#   (default: true)
#
# == Examples
#
